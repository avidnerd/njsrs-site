          ...
          <div className="flex">
            ...
            <div className="ml-3">
              <p className="text-sm text-yellow-700">
                <strong>Editing Disabled:</strong> The deadline for editing the Statement of Outside Assistance was April 16, 2026. You can still view your form, but editing is no longer available.
              </p>
            </div>
          </div>
        </div>
