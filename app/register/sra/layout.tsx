...
export const metadata: Metadata = {
  ...
  keywords: ['SRA registration', 'Science Research Advisor', 'teacher registration', 'school advisor registration', 'NJSRS SRA', 'research competitions New Jersey', 'student research competitions new jersey', 'high school research competition','science competition advisor'],
  openGraph: {
